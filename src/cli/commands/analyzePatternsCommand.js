...
async function analyzeBranchPatterns() {
  ...
  try {
    ...
    if (totalStandardBranches === 0) {
      console.log(chalk.yellow('\nNo se detectaron suficientes ramas que sigan los patrones estándar para el análisis.'));
      console.log(chalk.gray('Asegúrate de usar "gitbrancher new" para crear tus ramas y que el historial esté disponible.'));
      return;
    }
